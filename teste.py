...
if origem not in nos or destino not in nos:
    ...
    caminho = sol.prof_limitada(origem, destino, 5)
    print("\n***** PROFUNDIDADE LIMITADA ( L =",5,")*****\n",caminho)
    
    caminho = sol.prof_limitada(origem, destino, 8)
    print("\n***** PROFUNDIDADE LIMITADA ( L =",8,")*****\n",caminho)
